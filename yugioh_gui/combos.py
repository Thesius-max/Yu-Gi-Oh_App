...
durchgehen). Die Notation-Kurzreferenz (NOTATION_MD) liegt im
Blatt-Modul notation (geteilt mit dem Handbuch).
"""
...
class ComboView(QWidget):
    def __init__(self, repo: CardRepository):
        ...
        self.lint_label.setObjectName("LintLabel")
